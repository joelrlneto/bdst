  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Acesse a plataforma</p>
        <form action="<?php echo base_url('/index.php/autenticacao/acessar'); ?>" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Usuário" name="login" focused/>
        ...
        <a href="<?php echo base_url('/index.php/home/cadastro'); ?>" class="text-center">Ainda não sou cadastrado.</a>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
